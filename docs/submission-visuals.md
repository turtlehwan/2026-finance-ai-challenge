...
- 핵심 문장: 지급·정의·제한·면책에 골절은 질병분류표, 입원은 청구서류를 더해 사례별 5유형을 검사한다.
...
| 15건 | 규칙 재확인 경계 사례 | 같은 상품군의 작은 스모크 점검 | 독립 holdout·실사용 성능 |
| 2건 | 공식 근거 미연결 안전 중단 | 추천 0건·결과 차단·trace | 해당 보장 해석·지급 정확도 |
