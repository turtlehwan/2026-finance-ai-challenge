...
- 정의·지급·면책·제한 조항을 결정론적 관계 그래프로 함께 확장하고, 근거 경로가
  끊기면 결론을 만들지 않는다.
...
- 결과에는 실제 적용 상품 약관의 출처 URL·판매기간·페이지·SHA-256을 공개한다.
  표준약관은 상품 약관을 대체하지 않는 공통 구조·PolicyOps 검토 기준으로 분리한다.
...
2. **정의·지급·면책을 잇는 결정론적 근거 그래프**
   임베딩 유사도나 모델 기억으로 조항을 고르지 않는다. 상품·버전별로
   구조화한 조항 ID와 연결 관계를 따라 반대 근거까지 함께 검토한다.
...
- **Evidence Auditor Agent**: 잘못된 버전, 인용 오류, 면책 누락, 근거 없는
  단정 탐지
- **결정론적 도구**: 상품·계약일 파싱, 버전 계산, 조항 관계 확장,
...
| 상품·버전 | 상품코드 | 공식 판매기간 | 실제 분석 사례 |
|---|---|---|---|
| 무배당 우체국와이드건강보험 2112 | P400051~P400054 | 2021-12-01~2025-04-02 | S52 골절 특약 |
| 무배당 우체국와이드건강보험 2504 | P400073~P400076 | 2025-04-03~2025-06-04 | S52 골절 특약 |
| 무배당 우체국온라인입원수술보험 2112 | P600107 | 2021-12-01~2025-04-02 | 4일 이상 입원·수술 확인 |
