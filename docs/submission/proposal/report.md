...
- 계약일에 맞는 보험약관 버전을 먼저 고른 뒤 지급·정의·제한·면책·서류 조항을
  함께 확인한다.
...
> `생활재해보장특약Ⅱ`가 있었지만, 이 이름만으로는 골절진단비를 확인해야 하는지
> 알 수 없었다. 계약일에 맞는 보험약관에서 S52 골절의 정의, 지급 조건, 제한·면책,
> 준비 서류를 함께 찾아야 비로소 보험회사에 무엇을 물어볼지 정할 수 있다.
...
| 지급 문장만 보면 예외를 놓침 | 정의·제한·면책·서류까지 추적 | 필수 근거 5유형 동반 조회 | Claim Evidence Map |
