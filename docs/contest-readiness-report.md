...
- **제출 전 결정은 기능 확장이 아니라 증거 고정이다.** 공식 HWPX 전사, 90초 심사자 실행 경로, 실패 사례 캡처, URL 접근 기간 smoke test를 우선하고, 새 모델·새 Agent는 추가하지 않는다.
...
|---|---|---|---|
| P0 | DAKER HWPX 양식에 최신 기획서·기능명세서 전사 | 팀명·팀원 입력 PDF 2개, 항목 순서 일치 | 형식 결격 또는 문서-URL 불일치 |
